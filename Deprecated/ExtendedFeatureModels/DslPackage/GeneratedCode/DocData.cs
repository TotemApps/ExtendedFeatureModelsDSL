...
namespace jsoto0025.SplModeling.ExtendedFeatureModels
{
	...
	/// </summary>
	internal partial class ExtendedFeatureModelsDocData : ExtendedFeatureModelsDocDataBase
	{
		/// <summary>
		/// Constructs a new ExtendedFeatureModelsDocData.
		/// </summary>
		public ExtendedFeatureModelsDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a ExtendedFeatureModels document in memory.
	/// </summary>
	internal abstract partial class ExtendedFeatureModelsDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new ExtendedFeatureModelsDocDataBase.
		/// </summary>
		protected ExtendedFeatureModelsDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::jsoto0025.SplModeling.ExtendedFeatureModels.FeatureModel modelRoot = null;
			...
			global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::jsoto0025.SplModeling.ExtendedFeatureModels.FeatureModel modelRoot = (global::jsoto0025.SplModeling.ExtendedFeatureModels.FeatureModel)this.RootElement;
			...
			{
				global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsDiagram diagram = diagrams[0] as global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::jsoto0025.SplModeling.ExtendedFeatureModels.FeatureModel modelRoot = this.RootElement as global::jsoto0025.SplModeling.ExtendedFeatureModels.FeatureModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
