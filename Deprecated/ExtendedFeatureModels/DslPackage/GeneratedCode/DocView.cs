...
namespace jsoto0025.SplModeling.ExtendedFeatureModels
{
	...
	/// </summary>
	internal partial class ExtendedFeatureModelsDocView : ExtendedFeatureModelsDocViewBase
	{
		/// <summary>
		/// Constructs a new ExtendedFeatureModelsDocView.
		/// </summary>
		public ExtendedFeatureModelsDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class ExtendedFeatureModelsDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new ExtendedFeatureModelsDocView.
		/// </summary>
		protected ExtendedFeatureModelsDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			ExtendedFeatureModelsDocDataBase docData = this.DocData as ExtendedFeatureModelsDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for ExtendedFeatureModelsDocViewBase should be an ExtendedFeatureModelsDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.ExtendedFeatureModelsDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
