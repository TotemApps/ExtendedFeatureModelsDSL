...
namespace jsoto0025.SplModeling.ExtendedFeatureModels
{
	...
	/// </summary>
	internal partial class ExtendedFeatureModelsCommandSet : ExtendedFeatureModelsCommandSetBase
	{
		/// <summary>
		/// Constructs a new ExtendedFeatureModelsCommandSet.
		/// </summary>
		public ExtendedFeatureModelsCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class ExtendedFeatureModelsCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new ExtendedFeatureModelsCommandSetBase.
		/// </summary>
		protected ExtendedFeatureModelsCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewExtendedFeatureModelsExplorerCommand,
				typeof(ExtendedFeatureModelsEditorFactory).GUID);
		...
		{
			ExtendedFeatureModelsExplorerToolWindow explorer = this.ExtendedFeatureModelsExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected ExtendedFeatureModelsDocData CurrentExtendedFeatureModelsDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as ExtendedFeatureModelsDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected ExtendedFeatureModelsDocView CurrentExtendedFeatureModelsDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as ExtendedFeatureModelsDocView;
			}
		}
		...
		/// </summary>
		protected ExtendedFeatureModelsExplorerToolWindow ExtendedFeatureModelsExplorerToolWindow
		{
			get
			{
				ExtendedFeatureModelsExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(ExtendedFeatureModelsExplorerToolWindow), true) as ExtendedFeatureModelsExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				ExtendedFeatureModelsExplorerToolWindow explorerWindow = this.ExtendedFeatureModelsExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class ExtendedFeatureModelsClipboardCommandSet : ExtendedFeatureModelsClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new ExtendedFeatureModelsClipboardCommandSet.
		/// </summary>
		public ExtendedFeatureModelsClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class ExtendedFeatureModelsClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new ExtendedFeatureModelsClipboardCommandSetBase.
		/// </summary>
		protected ExtendedFeatureModelsClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
