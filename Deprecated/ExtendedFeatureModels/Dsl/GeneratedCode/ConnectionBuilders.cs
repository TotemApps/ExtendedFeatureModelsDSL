...
namespace jsoto0025.SplModeling.ExtendedFeatureModels
{
	...
	/// </summary>
	public static partial class FeatureReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::jsoto0025.SplModeling.ExtendedFeatureModels.Feature)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::jsoto0025.SplModeling.ExtendedFeatureModels.Feature)
				{
					if (candidateTarget is global::jsoto0025.SplModeling.ExtendedFeatureModels.Feature)
					{
						global::jsoto0025.SplModeling.ExtendedFeatureModels.Feature sourceFeature = (global::jsoto0025.SplModeling.ExtendedFeatureModels.Feature)candidateSource;
						global::jsoto0025.SplModeling.ExtendedFeatureModels.Feature targetFeature = (global::jsoto0025.SplModeling.ExtendedFeatureModels.Feature)candidateTarget;
						if(targetFeature == null || sourceFeature == null || global::jsoto0025.SplModeling.ExtendedFeatureModels.FeatureReferencesTargets.GetLinks(sourceFeature, targetFeature).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::jsoto0025.SplModeling.ExtendedFeatureModels.Feature)
				{
					if (target is global::jsoto0025.SplModeling.ExtendedFeatureModels.Feature)
					{
						global::jsoto0025.SplModeling.ExtendedFeatureModels.Feature sourceAccepted = (global::jsoto0025.SplModeling.ExtendedFeatureModels.Feature)source;
						global::jsoto0025.SplModeling.ExtendedFeatureModels.Feature targetAccepted = (global::jsoto0025.SplModeling.ExtendedFeatureModels.Feature)target;
						DslModeling::ElementLink result = new global::jsoto0025.SplModeling.ExtendedFeatureModels.FeatureReferencesTargets(sourceAccepted, targetAccepted);
	...
	/// </summary>
	internal partial class FeatureRelationshipConnectAction : DslDiagrams::ConnectAction
	{
		private DslDiagrams::ConnectionType[] connectionTypes;
		
		/// <summary>
		/// Constructs a new FeatureRelationshipConnectAction for the given Diagram.
		/// </summary>
		public FeatureRelationshipConnectAction(DslDiagrams::Diagram diagram): base(diagram, true) 
		{
		}
		...
		/// <summary>
		/// Returns the FeatureRelationshipConnectionType associated with this action.
		/// </summary>
		protected override DslDiagrams::ConnectionType[] GetConnectionTypes(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement)
		{
			...
			{
				this.connectionTypes = new DslDiagrams::ConnectionType[] { new FeatureRelationshipConnectionType() };
			}
			
			return this.connectionTypes;
		}
		
		private partial class FeatureRelationshipConnectionTypeBase : DslDiagrams::ConnectionType
		{
			/// <summary>
			/// Constructs a new the FeatureRelationshipConnectionType with the given ConnectionBuilder.
			/// </summary>
			protected FeatureRelationshipConnectionTypeBase() : base() {}
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder FeatureReferencesTargetsBuilder.
			/// </remarks>
			public override bool CanCreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, ref string connectionWarning)
			{
				...
				{				
					if(targetShapeElement == null)
					{
						return FeatureReferencesTargetsBuilder.CanAcceptSource(sourceElement);
					}
					else
					{				
						return FeatureReferencesTargetsBuilder.CanAcceptSourceAndTarget(sourceElement, targetElement);
					}
				}
				else
				{
			...
			public override void CreateConnection(DslDiagrams::ShapeElement sourceShapeElement, DslDiagrams::ShapeElement targetShapeElement, DslDiagrams::PaintFeedbackArgs paintFeedbackArgs)
			{
				...
				if(targetElement == null) targetElement = targetShapeElement;
				FeatureReferencesTargetsBuilder.Connect(sourceElement, targetElement);
			}
		}
		
		private partial class FeatureRelationshipConnectionType : FeatureRelationshipConnectionTypeBase
		{
			/// <summary>
			/// Constructs a new the FeatureRelationshipConnectionType with the given ConnectionBuilder.
			/// </summary>
			public FeatureRelationshipConnectionType() : base() {}
		}
	}
}
