...
namespace jsoto0025.SplModeling.ExtendedFeatureModels
{
	...
	/// </remarks>
	public partial class ExtendedFeatureModelsToolboxHelper : ExtendedFeatureModelsToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new ExtendedFeatureModelsToolboxHelper.
		/// </summary>
		public ExtendedFeatureModelsToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class ExtendedFeatureModelsToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify ExtendedFeatureModels toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "ExtendedFeatureModels.1.0";
		/// <summary>
		/// Toolbox item filter string used to identify FeatureRelationship connector tool.
		/// </summary>
		public const string FeatureRelationshipFilterString = "FeatureRelationship.1.0";
		...
		/// <summary>
		/// Constructs a new ExtendedFeatureModelsToolboxHelperBase.
		/// </summary>
		protected ExtendedFeatureModelsToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsDomainModel.SingletonResourceManager.GetString("ExtendedFeatureModelsToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "jsoto0025.SplModeling.ExtendedFeatureModels.FeatureElementToolboxItem":
					// Add FeatureElement shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"jsoto0025.SplModeling.ExtendedFeatureModels.FeatureElementToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("ExtendedFeatureModelsToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::jsoto0025.SplModeling.ExtendedFeatureModels.Feature.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "jsoto0025.SplModeling.ExtendedFeatureModels.FeatureRelationshipToolboxItem":

					// Add FeatureRelationship connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"jsoto0025.SplModeling.ExtendedFeatureModels.FeatureRelationshipToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						2, // Position relative to other items in the same toolbox tab.
						resourceManager.GetString("FeatureRelationshipToolboxItem", resourceCulture), // Localized display name for the item.
						(global::System.Drawing.Bitmap)DslDiagrams::ImageHelper.GetImage(resourceManager.GetObject("FeatureRelationshipToolboxBitmap", resourceCulture)), // Image displayed next to the toolbox item.				
						"jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("ExtendedFeatureModelsToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						"ConnectExampleRelationF1Keyword", // F1 help keyword for the toolbox item.
						resourceManager.GetString("FeatureRelationshipToolboxTooltip", resourceCulture), // Localized tooltip text for the toolbox item.
						null, // Connector toolbox items do not have an underlying data object.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
							new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require), 
							new global::System.ComponentModel.ToolboxItemFilterAttribute(FeatureRelationshipFilterString)
						});
					break;
				default:
					break;
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsDomainModel));
