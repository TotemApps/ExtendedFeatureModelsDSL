...
namespace jsoto0025.SplModeling.ExtendedFeatureModels
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides ExtendedFeatureModels files
	/// The implementation is done in ExtendedFeatureModelsDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class ExtendedFeatureModelsDirectiveProcessor : ExtendedFeatureModelsDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public ExtendedFeatureModelsDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides ExtendedFeatureModels files
	/// </summary>
	public class ExtendedFeatureModelsDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string ExtendedFeatureModelsDirectiveProcessorName = "ExtendedFeatureModelsDirectiveProcessor";
		...
		/// </summary>
		private const string providesModelParameter = "FeatureModel";
		...
		/// </summary>
		private const string supportedDirectiveName = "ExtendedFeatureModels";
		...
		/// Constructor
		/// </summary>
		public ExtendedFeatureModelsDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return ExtendedFeatureModelsDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::jsoto0025.SplModeling.ExtendedFeatureModels.FeatureModel));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::jsoto0025.SplModeling.ExtendedFeatureModels.FeatureModel));
					...
					if (!this.oneTimeCodeGenerated && global::System.IO.File.Exists(this.Host.TemplateFile))
					{
						...
						resolver.Name = "Convert" + "FeatureModel" + "RelativePathToTemplateRelativePath";
		...
		protected override void GeneratePreInitializationCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				{
					string[] domainModels = {
						"jsoto0025.SplModeling.ExtendedFeatureModels.ExtendedFeatureModelsDomainModel",
					};
				...
				if (languageProvider != null)
				{
					...
					if(LoadDiagramData)
					{
						...
						invokeEnableDiagramRules = new global::System.CodeDom.CodeMethodInvokeExpression(
							new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression("ExtendedFeatureModelsDomainModel"), "EnableDiagramRules"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"));
		...
		public override string[] GetImportsForProcessingRun()
		{
			...
			imports.Add("jsoto0025.SplModeling.ExtendedFeatureModels");
