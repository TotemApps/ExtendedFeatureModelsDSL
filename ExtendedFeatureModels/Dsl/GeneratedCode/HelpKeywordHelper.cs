...
namespace jsoto0025.SplModeling.ExtendedFeatureModels
{
	...
	/// </remarks>
	public partial class ExtendedFeatureModelsHelpKeywordHelper : ExtendedFeatureModelsHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new ExtendedFeatureModelsHelpKeywordHelper.
		/// </summary>
		protected ExtendedFeatureModelsHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the ExtendedFeatureModelsHelpKeywordHelper.
		/// </summary>
		public static ExtendedFeatureModelsHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class ExtendedFeatureModelsHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new ExtendedFeatureModelsHelpKeywordHelperBase.
		/// </summary>
		protected ExtendedFeatureModelsHelpKeywordHelperBase()
			: base() { }
