...
namespace Company.SplLanguage
{
	...
	/// </summary>
	internal partial class SplLanguageCommandSet : SplLanguageCommandSetBase
	{
		/// <summary>
		/// Constructs a new SplLanguageCommandSet.
		/// </summary>
		public SplLanguageCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class SplLanguageCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new SplLanguageCommandSetBase.
		/// </summary>
		protected SplLanguageCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewSplLanguageExplorerCommand,
				typeof(SplLanguageEditorFactory).GUID);
		...
		{
			SplLanguageExplorerToolWindow explorer = this.SplLanguageExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentSplLanguageDocData != null && this.CurrentSplLanguageDocData.Store != null)
			{
				this.CurrentSplLanguageDocData.ValidationController.Validate(this.CurrentSplLanguageDocData.GetAllElementsForValidation(), DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentSplLanguageDocData != null && this.CurrentSplLanguageDocData.Store != null)
			{
				...
				this.CurrentSplLanguageDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected SplLanguageDocData CurrentSplLanguageDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as SplLanguageDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected SplLanguageDocView CurrentSplLanguageDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as SplLanguageDocView;
			}
		}
		...
		/// </summary>
		protected SplLanguageExplorerToolWindow SplLanguageExplorerToolWindow
		{
			get
			{
				SplLanguageExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(SplLanguageExplorerToolWindow), true) as SplLanguageExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				SplLanguageExplorerToolWindow explorerWindow = this.SplLanguageExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class SplLanguageClipboardCommandSet : SplLanguageClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new SplLanguageClipboardCommandSet.
		/// </summary>
		public SplLanguageClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class SplLanguageClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new SplLanguageClipboardCommandSetBase.
		/// </summary>
		protected SplLanguageClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
